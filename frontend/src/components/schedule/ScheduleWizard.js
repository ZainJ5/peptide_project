        ...
        {disclaimerOpen && (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
            ...
            <motion.div initial={{ scale: 0.95, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} exit={{ scale: 0.95, opacity: 0 }}
              ...
              <div className="px-5 py-4 space-y-3 text-sm leading-relaxed text-slate-700"><p className="font-semibold text-slate-900">Always consult a licensed healthcare professional before beginning any new supplement or peptide regimen. The information provided by this calendar is for educational purposes only and does not constitute medical advice. You are solely responsible for ensuring that any products used are sourced safely and legally. By proceeding, you acknowledge that you are using this tool at your own risk.</p><label className="mt-3 flex items-start gap-2 rounded-xl border border-slate-200 bg-slate-50/80 px-3 py-3 text-sm text-slate-800">
                  <input
                    type="checkbox"
