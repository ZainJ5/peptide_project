            ...
            <div className="relative w-full bg-gradient-to-b from-slate-100 to-slate-50">
              {peptide.imageUrl ? (
                ...
                <div className="flex h-44 items-center justify-center">
                  <svg className="h-16 w-16 text-slate-300" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1"><path strokeLinecap="round" strokeLinejoin="round" d="M9.75 3.104v5.714a2.25 2.25 0 01-.659 1.591L5 14.5M9.75 3.104c-.251.023-.501.05-.75.082m.75-.082a24.301 24.301 0 014.5 0" /></svg>
                </div>
              )}
            </div>
            {/* Content */}
            ...
            <div className="relative bg-gradient-to-br from-slate-50 to-slate-100/80">
              {peptide.imageUrl ? (
                ...
                <div className="flex h-full min-h-[280px] items-center justify-center">
                  <svg className="h-20 w-20 text-slate-300" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="0.8"><path strokeLinecap="round" strokeLinejoin="round" d="M9.75 3.104v5.714a2.25 2.25 0 01-.659 1.591L5 14.5M9.75 3.104c-.251.023-.501.05-.75.082m.75-.082a24.301 24.301 0 014.5 0" /></svg>
                </div>
              )}
            </div>
          </div>
        ...
        <div className="flex flex-col lg:flex-row">
          ...
          <section className="flex-1 min-w-0 space-y-6">
            ...
            <div id="overview" className="scroll-mt-6">
              <SectionCard title="Overview & Mechanism" icon="overview">
            ...
            <div id="guidance" className="scroll-mt-6">
              <SectionCard title="Protocol Guidance" icon="guidance">
                <div className="grid gap-3 sm:grid-cols-2">
                  <div className="rounded-xl bg-gradient-to-br from-slate-50 to-slate-100/50 p-5 border border-slate-200/60">
                    <div className="flex items-center gap-2.5 mb-3">
                      <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-white shadow-sm border border-slate-200/60">
                        <svg className="h-4 w-4 text-(--color-primary)" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5"><path strokeLinecap="round" strokeLinejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                      </div>
                      <h3 className="text-sm font-bold text-slate-900">Injection Frequency</h3>
                    </div>
                  ...
                  <div className="rounded-xl bg-gradient-to-br from-slate-50 to-slate-100/50 p-5 border border-slate-200/60">
                    <div className="flex items-center gap-2.5 mb-3">
                      <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-white shadow-sm border border-slate-200/60">
                        <svg className="h-4 w-4 text-(--color-primary)" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5"><path strokeLinecap="round" strokeLinejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0v-7.5A2.25 2.25 0 015.25 9h13.5A2.25 2.25 0 0121 11.25v7.5" /></svg>
                      </div>
                      <h3 className="text-sm font-bold text-slate-900">Cycle Duration</h3>
                    </div>
            ...
            <div id="benefits" className="scroll-mt-6 space-y-5">
              <SectionCard title="Clinical Benefits" icon="benefits">
                {benefits.length > 0 ? (
                  <div className="grid gap-3 sm:grid-cols-2">
            ...
            <div id="dosage" className="scroll-mt-6">
              <SectionCard title="Dosage & Escalation" icon="dosage">
                ...
                {tableData.length > 0 ? (
                  ...
                  <div className="rounded-xl border border-slate-200 bg-slate-50/50 p-5">
                    ...
                    <p className="mt-1 text-sm text-slate-500">Review injection frequency and cycle schedule in the guidance section above.</p>
                  </div>
                )}
              </SectionCard>
            </div>
            ...
            <div id="reconstitution" className="scroll-mt-6">
              <CustomCollapsibleSection
                title="Reconstitution & Preparation"
                iconElem={
                  <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-(--color-primary)/10">
                    <svg className="h-4.5 w-4.5 text-(--color-primary)" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
              ...
              >
                {/* Reconstitution reference image — full width, prominent */}
                ...
                <div className="p-5 sm:p-6 space-y-5">
                  {/* Step 1 — Reconstitution requirements */}
                  ...
                  <div className="rounded-xl bg-gradient-to-br from-slate-50 to-white border border-slate-200/60 p-5">
                    <div className="flex items-center gap-3 mb-4">
                      <div className="flex h-7 w-7 items-center justify-center rounded-lg bg-(--color-primary) text-white text-xs font-bold">2</div>
                      <h3 className="text-sm font-bold text-slate-900">Final Preparation Notes</h3>
                    </div>
                    {preparationNotes.length > 0 ? (
                      ...
                      <p className="text-sm text-slate-500 ml-10">Standard clinical preparation protocols apply.</p>
                    )}
                  </div>
                </div>
              </CustomCollapsibleSection>
...
function QuickStat({ icon, label, value }) {
  const icons = {
    ...
    recon: <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 3.104v5.714a2.25 2.25 0 01-.659 1.591L5 14.5M9.75 3.104c-.251.023-.501.05-.75.082m.75-.082a24.301 24.301 0 014.5 0" />,
  };
