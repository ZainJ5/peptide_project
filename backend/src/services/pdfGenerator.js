...
function generateCalendarPdf({ groupedEvents, scheduleName = 'Peptide Schedule', userName = '', months }) {
  ...
  pageChunks.forEach((weeksOnPage, pageIndex) => {
    ...
    doc.fillColor(COLORS.footerText).font('Helvetica').fontSize(8).text('Generated by PeptideDosage.com  |  For research purposes only', LEFT, doc.page.height - BOTTOM - 10, {
      width: PAGE_W,
      align: 'center',
    });
  });
